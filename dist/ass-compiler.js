    ...
    for (var i = 0; i < parsed.length; i++) {
      ...
      for (var j$1 = 0; j$1 < tags.length; j$1++) {
        ...
        if (key && !~globalTags.indexOf(key)) {
          var ref$2 = styles[slice.style] ? styles[slice.style].tag : styles["Default"].tag;
          var c1 = ref$2.c1;
          var c2 = ref$2.c2;
          var c3 = ref$2.c3;
          var c4 = ref$2.c4;
          var fs = prevTag.fs || styles[slice.style] ? styles[slice.style].tag.fs : styles["Default"].tag.fs;
